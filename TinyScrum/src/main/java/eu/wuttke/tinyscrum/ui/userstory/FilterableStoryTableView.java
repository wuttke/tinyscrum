...
implements ValueChangeListener, ClickListener {
	...
	@AutoGenerated
	private Select comboBoxCustomerProject;
	@AutoGenerated
	...
	private CustomerProject CUSTOMER_PROJECT_NOT_ASSIGNED = new CustomerProject("NOT ASSIGNED");
	...
	private UserStoryFilter readFilter() {
		...
		CustomerProject customerProject = (CustomerProject)comboBoxCustomerProject.getValue();
		if (customerProject != null) {
			filter.setFilterCustomerProject(true);
			if (customerProject != CUSTOMER_PROJECT_NOT_ASSIGNED)
				filter.setCustomerProjectEquals(customerProject);
		}
	...
	private void initCombo() {
		...
		comboBoxCustomerProject.addItem(CUSTOMER_PROJECT_NOT_ASSIGNED);
		for (CustomerProject customerProject : projectManager.loadCustomerProjects(p, null))
			comboBoxCustomerProject.addItem(customerProject);
		comboBoxCustomerProject.setImmediate(true);
		comboBoxCustomerProject.addListener(this);
	}
	...
	private HorizontalLayout buildHorizontalLayout() {
		...
		// comboBoxCustomerProject
		comboBoxCustomerProject = new Select();
		comboBoxCustomerProject.setCaption("Customer Project");
		comboBoxCustomerProject.setImmediate(false);
		comboBoxCustomerProject.setWidth("-1px");
		comboBoxCustomerProject.setHeight("-1px");
		horizontalLayout.addComponent(comboBoxCustomerProject);
